<section class="main-slider">
    <ul class="slides">
        <li class="bg-slider slider-rtl-2 d-flex align-items-center"
            style="background:url('{{ asset('storage/images/slider.jpg') }}') center/cover no-repeat;">
            <div class="container">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="title-heading mt-4">
                            ...
                            <p class="para-desc text-muted para-dark">Bakso yang terinspirasi dengan bola sehingga
                                berbentuk bulat.</p>
                            <div class="mt-4">
                                <a href="{{ route('shop') }}" class="btn btn-soft-primary">Beli Sekarang</a>
                            </div>
                        </div>
                    </div>
                    <!--end col-->
        ...
        {{-- <li class="bg-slider slider-rtl-1 d-flex align-items-center"
            style="background:url('{{ asset('storage/images/bakso.jpeg') }}') center center;">
        <div class="container">
            <div class="row align-items-center mt-5">
                <div class="col-lg-7 col-md-7">
                    <div class="title-heading mt-4">
